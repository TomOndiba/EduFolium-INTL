<?php 
	...
	*/
	...
	$spanish = array(
		...
		// widgets
		'widgets:profile_completeness:title' => 'Estado de Perfil',
		'widgets:profile_completeness:description' => 'Show the profile completeness',
		'widgets:profile_completeness:view:tips' => 'Actualiza tu(s) %s para mejorar tu perfil de Docente.',
		...
		'profile_manager:profile:edit:custom_profile_type:label' => "Seleccionar tipo de Perfil",
		...
		'profile_manager:register:mandatory' => "Campos marcados con * son requeridos",
		...
		'profile_manager:simple_access_control' => 'Quien puede ver mi información ?',
		...
		'profile_manager:account:username:button' => "Click para cambiar el nombre de usuario",
		...
		// river events
		'river:join:site:default' => '%s se unió a EduFolium',
