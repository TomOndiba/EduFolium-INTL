...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $lang; ?>" lang="<?php echo $lang; ?>">
	...
	<div id="sociaRegister" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="sociaRegisterLabel" aria-hidden="true">
        <div class="modal-header">
            ...
            <h3 id="sociaRegisterLabel"><?php echo elgg_echo("Registro - Colegio"); ?></h3>
        </div>
		...
		<div id="schools_container">
			...
			<section class="section1">
				<h1>Want to create job postings that reach only experienced IB teachers?</h1>
				<p>EduFolium for IB is building the largest community of IB teachers around the world. We only allow access to teachers that can certify their experience. In addition, via ranked samples of the teaching resources they create, we provide you with valuable insights to evaluate your prospects. 
				</p>
			</section>
			...
			<div id="callAct">
				<spam class="destDos">
					If you are interested in becoming one of the first schools to have access to this service, please sign up<br> 
					with us below:
				</spam>
