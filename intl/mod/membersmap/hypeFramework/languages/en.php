...
$english = array(
     ...
     * Forms
     */
    'hj:label:hjportfoliofile:title' => 'Title of Learning Experience',
    ...
    'hj:label:hjportfoliofile:Course' => 'Course',
	'hj:label:hjportfoliofile:Syllabus' => 'Syllabus Section',
	'hj:label:hjportfoliofile:Type' => 'Type of Resourse',
	'hj:label:hjportfoliofile:Programme' => 'Programme',
	'hj:label:hjportfoliofile:IB_moderated'	=> 'Which IB-moderated assessment task is this resource designed to support?',
	'hj:label:hjportfoliofile:Recommend'	=> 'Why do you recommend this to other teachers? In what circumstances would other teachers find this resource useful?',
