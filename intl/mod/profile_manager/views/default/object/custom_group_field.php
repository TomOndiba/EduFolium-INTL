	...
	*/
	...
	if(!empty($vars['entity']->metadata_label)){
		...
		if(elgg_echo("profile:" . $vars['entity']->metadata_name) == "groups:" . $vars['entity']->metadata_name){
			$extra_info .= elgg_echo("profile_manager:admin:metadata_label_untranslated") . ": <i>" . elgg_echo("groups:" . $vars['entity']->metadata_name) . "</i>";
		} else {
			$extra_info .= elgg_echo("profile_manager:admin:metadata_label_translated") . ": " . elgg_echo("groups:" . $vars['entity']->metadata_name) . "";
		}
	}
