...
$spanish = array( 
	 ...
	 'invitefriends:introduction'  =>  "Para invitar a tus amigos a entrar en EduFolium, introduce sus direcciones de email en la parte de abajo. Una dirección de email para cada línea:" , 
	 'invitefriends:message'  =>  "Introduce un mensaje de invitación:" , 
	 'invitefriends:subject'  =>  "Invitación para %s" , 
	 'invitefriends:success'  =>  "Las invitaciones han sido enviadas con éxito. Gracias por hacer crecer nuestra comunidad de Educadores." , 
