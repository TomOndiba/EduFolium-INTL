...
$sidebar .= '<input class="elgg-input-text" id="radius" type="text" value="" placeholder="'.elgg_echo("membersmap:search:radius").'">';
...
$sidebar .= '<input class="elgg-input-text" name="radius" type="text" value="'.sanitize_string(get_input('radius')).'" placeholder="'.elgg_echo("membersmap:search:radius").'">';
...
if ($user = elgg_get_logged_in_user_entity())   {
    if (!empty($user->location))    {
        ...
        $sidebar .= '<input class="elgg-input-text" id="radiusmyloc" type="text" value="" placeholder="'.elgg_echo("membersmap:search:radius").'">';
...
//Hide Side Bar
$sidebar .= '<script>';
$sidebar .= '$(".elgg-sidebar").css( "display", "none" )';
$sidebar .= '</script>';
