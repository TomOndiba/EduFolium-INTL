...
$cv_paste_cv = elgg_extract('cv_paste_cv', $vars, ''); //backward compatibility
...
<div class="form-wide">
	...
	<div style='width:100%; clear:both;'>
		<?php echo elgg_view('input/longtext', array('name' => 'description', 'value' => $description, 'class' => 'cv_paste_cv')); ?>
	</div>
</div>
